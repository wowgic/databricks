...
model_name = "dbdemos_mlops"
input_table_name = "default.delta_production"
output_table_path = "/FileStore/batch-inference/dbdemos_mlops"
...
# MAGIC ```python
# MAGIC output_table = "" # Example: "ml.batch-inference.dbdemos_mlops"
